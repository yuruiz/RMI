package RMIServer;/* This does not offer the code of the whole communication module
   (CM) for RMI: but it gives some hints about how you can make 
   it. I call it simply "RMIServer.yourRMI".
...
public class yourRMI {
    ...
    public static void main(String args[]) throws Exception {
        ...
        // as a hint, I give such a table's interface as RMIServer.RORtbl.java.
