...
//
//   java RMIServer.yourRMI ZipCodeServerImpl registryhost resigstryport servicename
//
...
public class ZipCodeServerImpl implements ZipCodeServer {
    ...
    public String find(String request) {
        // search the list.
        ZipCodeList temp = l;
        while (temp != null && !temp.city.equals(request)) temp = temp.next;

        // the result is either null or we found the match.
        if (temp == null) return null;
        else return temp.ZipCode;
    }
