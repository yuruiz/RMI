...
public final class Hello_Stub extends RemoteStub implements HelloInterface,
		Remote {
	...
	public String sayHello(String s) throws RemoteException {
		try {
			if (useNewInvoke) {
				Object obj = super.ref.invoke(this, $method_sayHello_0,
						new Object[] { s }, 0x742a8a860d6b7ee4L);
				return (String) obj;
			}
			RemoteCall remotecall = super.ref.newCall(this, operations, 0,
					0x38bc97be171621e6L);
			try {
	...
	static {
		try {
			(java.rmi.server.RemoteRef.class).getMethod("invoke", new Class[] {
					java.rmi.Remote.class, java.lang.reflect.Method.class,
					java.lang.Object[].class, Long.TYPE });
			useNewInvoke = true;
